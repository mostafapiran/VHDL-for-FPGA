...
-- Generated on: 2020-07-20 01:12:13
-- -------------------------------------------------------------
...
--
-- TargetLanguage: VHDL
-- TargetDirectory: C:\Users\mostafa\Desktop\filter_IIR_matlab\100
-- Name: filter_100
...
----------------------------------------------------------------
--Module Architecture: filter_100
----------------------------------------------------------------
ARCHITECTURE rtl OF filter_100 IS
  -- Local Functions
  -- Type Definitions
  ...
  -- Constants
  CONSTANT scaleconst1                    : real := 9.7907068204958358E-01; -- double
  CONSTANT coeff_b1_section1              : real := 1.0000000000000000E+00; -- double
  CONSTANT coeff_b2_section1              : real := -6.1803398874989490E-01; -- double
  CONSTANT coeff_b3_section1              : real := 9.9999999999999967E-01; -- double
  CONSTANT coeff_a2_section1              : real := -6.0509895889518417E-01; -- double
  CONSTANT coeff_a3_section1              : real := 9.5814136409916706E-01; -- double
  -- Signals
