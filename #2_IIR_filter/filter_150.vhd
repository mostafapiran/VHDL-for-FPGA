...
-- Generated on: 2020-07-20 01:14:53
-- -------------------------------------------------------------
...
--
-- TargetLanguage: VHDL
-- TargetDirectory: C:\Users\mostafa\Desktop\filter_IIR_matlab\150
-- Name: filter_150
...
----------------------------------------------------------------
--Module Architecture: filter_150
----------------------------------------------------------------
ARCHITECTURE rtl OF filter_150 IS
  -- Local Functions
  -- Type Definitions
  ...
  -- Constants
  CONSTANT scaleconst1                    : real := 9.7612039385260396E-01; -- double
  CONSTANT coeff_b1_section1              : real := 1.0000000000000000E+00; -- double
  CONSTANT coeff_b2_section1              : real := 6.1803398874989479E-01; -- double
  CONSTANT coeff_b3_section1              : real := 9.9999999999999967E-01; -- double
  CONSTANT coeff_a2_section1              : real := 6.0327558051284313E-01; -- double
  CONSTANT coeff_a3_section1              : real := 9.5224078770520815E-01; -- double
  -- Signals
