...
-- Generated on: 2020-07-20 01:21:54
-- -------------------------------------------------------------
...
--
-- TargetLanguage: VHDL
-- TargetDirectory: C:\Users\mostafa\Desktop\filter_IIR_matlab\250
-- Name: filter_250
...
----------------------------------------------------------------
--Module Architecture: filter_250
----------------------------------------------------------------
ARCHITECTURE rtl OF filter_250 IS
  -- Local Functions
  -- Type Definitions
  ...
  -- Constants
  CONSTANT scaleconst1                    : real := 9.8050021244833729E-01; -- double
  CONSTANT coeff_b1_section1              : real := 1.0000000000000000E+00; -- double
  CONSTANT coeff_b2_section1              : real := 1.9999999999999842E+00; -- double
  CONSTANT coeff_b3_section1              : real := 9.9999999999999989E-01; -- double
  CONSTANT coeff_a2_section1              : real := 1.9610004248966590E+00; -- double
  CONSTANT coeff_a3_section1              : real := 9.6100042489667470E-01; -- double
  -- Signals
